...
namespace EF.Cupons.Domain.Test.Models
{
    ...
    public class CupomTest(CupomFixture fixture)
    {
        ...
        {
            // Arrange - Act
            Action act = () => fixture.GerarCupom(dataInicio: DateTime.Now.AddDays(-1));
        ...
        {
            // Arrange - Act
            Action act = () => fixture.GerarCupom(dataInicio: DateTime.Now.AddDays(5), dataFim: DateTime.Now.AddDays(4));
