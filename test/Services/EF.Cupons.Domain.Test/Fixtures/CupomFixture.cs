...
namespace EF.Cupons.Domain.Test.Fixtures
{
    ...
    public class CupomFixture : IDisposable
    {
        ...
        public List<Cupom> GerarCupons(int quantidade, DateTime? dataInicio = null, DateTime? dataFim = null, string? codigoCupom = null,
                decimal? porcentagemDesconto = null, CupomStatus? status = null)
        {
            var estoques = new Faker<Cupom>("pt_BR")
                .CustomInstantiator(f => new Cupom(dataInicio ?? DateTime.Now,
                                                   ...
                                                   porcentagemDesconto ?? f.Random.Number(99),
