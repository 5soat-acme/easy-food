...
namespace EF.Estoques.Domain.Models
{
    public class MovimentacaoEstoque : Entity
    {
            ...
            OrigemMovimentacaoEstoque origemMovimentacao, DateTime dataLancamento)
        {
            ...
            if (!ValidarOrigemMovimentacaoCompativelTipoMovimentacao(tipoMovimentacao, origemMovimentacao)) throw new DomainException("OrigemMovimentacao incompatível com TipoMovimentacao");           
        ...
        private bool ValidarOrigemMovimentacaoCompativelTipoMovimentacao(TipoMovimentacaoEstoque tipoMovimentacao, OrigemMovimentacaoEstoque origemMovimentacao)
        {
            ...
            return tipoMovimentacao == TipoMovimentacaoEstoque.Entrada ? origemEntrada.Contains(origemMovimentacao) : origemSaida.Contains(origemMovimentacao);
        }
    }
}