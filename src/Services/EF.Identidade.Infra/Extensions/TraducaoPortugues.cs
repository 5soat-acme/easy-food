...
public class TraducaoPortugues : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string userName)
    {
        return new IdentityError
        {
            ...
            Description = $"O login '{userName}' é inválido, pode conter apenas letras ou dígitos."
        };
    }
    ...
    public override IdentityError PasswordRequiresNonAlphanumeric()
    {
        return new IdentityError
        {
            ...
            Description = "As senhas devem conter ao menos um caracter não alfanumérico."
        };
    }
    ...
    public override IdentityError PasswordRequiresDigit()
    {
        return new IdentityError
        {
            Code = nameof(PasswordRequiresDigit), Description = "As senhas devem conter ao menos um digito ('0'-'9')."
        };
    }
    ...
    public override IdentityError PasswordRequiresLower()
    {
        return new IdentityError
        {
            ...
            Description = "As senhas devem conter ao menos um caracter em caixa baixa ('a'-'z')."
        };
    }
    ...
    public override IdentityError PasswordRequiresUpper()
    {
        return new IdentityError
        {
            ...
            Description = "As senhas devem conter ao menos um caracter em caixa alta ('A'-'Z')."
        };
    }
}